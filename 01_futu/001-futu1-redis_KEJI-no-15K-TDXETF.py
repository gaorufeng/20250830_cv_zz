...
redis_host1 = '192.168.102.150'

redis_host2 = '192.168.102.150'
...
try: 
    ...
    ret_sub, err_message = quote_ctx.subscribe(codelist, [SubType.K_15M], subscribe_push=False)
...
for i in codelist:
    ...
    try: 
        ...
        if ret_sub == RET_OK:  # 订阅成功
            ret, data = quote_ctx.get_cur_kline(i, x500, KLType.K_15M, AuType.QFQ)  # 获取港股00700最近2个 K 线数据
            if ret == RET_OK:
                ...
                try:
                    ...
                    pandas_to_redis(redis_host1,'BY54_15K_'+i+'now_py1',data)
